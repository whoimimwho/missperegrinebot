...
`I'm here to help you manage your groups! Hit` *📚Commands* button below to find out more about how to use me to my full potential[.](https://telegra.ph/file/f54cc20ac06a80af7d842.jpg)' 
"""
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="👥 OUR CHANNEL", url="https://t.me/wearestrangethings"
        ),
    ],
]
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Miss Peregrine*, a powerful group management bot built to help you manage your group easily.
