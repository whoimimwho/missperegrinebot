        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                       InlineKeyboardButton(
            text="➕️ Add Me 🔘", url="t.me/MissPeregrinebot?startgroup=true"),
    ],
    ...
    try:
        if mod_match:
            ...
            query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="ã€Œ GO BACK ã€", callback_data="help_back")]]
                ),
            )
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" â„¹ï¸ I'm *Miss Peregrine*, a powerful group management bot built to help you manage your group easily.
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yes I'm alive ðŸ˜¹")
        except Unauthorized:
            LOGGER.warning(
