...
from LaylaRobot.moduless.helper_funcs.chat_status import dev_plus, sudo_plus
...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("LaylaRobot.moduless." +
                                                  text)
    except:
